...
class comm_sql_plc:
    ...
    def sql_to_plc_baja_alta(self, container_in, data_offset):
        ...
        try: 
            ...
            self.log(message=f'Error al ejecutar un query {e}')
            data = b'\xBB'
            self.client.db_write(self.db_data, data_offset + self.offset_estado_plc, data)
    ...
    def sesion_baja_alta(self):
        ...
        while True:
            ...
            except RuntimeError as e: self.log(message='Error de conexión con el PLC {e}')     
    ...
    def sesion_inspection(self):
        ...
        while True:
            ...
            except RuntimeError as e: self.log(message=f'Error de conexión con el PLC {e}')            

class comm_plc_sql:
    def __init__(self, server='10.19.142.2,1433', database='SofiaController', username='sa_controller', password='@Avante2023', ip_plc='10.19.143.1', rack=0, slot=1, db_control=[101, 102, 103, 104], periodo=1, tabla_rce='opc_ruteo_control_estatico', tabla_rcd='opc_ruteo_control_dinamico', tabla_cp='opc_ruteo_control_peso', route_log='C:/Users/fredlonlon/Documents/log.csv'):
