...
class comm_plc_sql:
    def __init__(self, server='10.19.142.2,1433', database='SofiaController', username='sa_controller', password='@Avante2023', ip_plc='10.19.143.1', rack=0, slot=1, db_control=[101, 102, 103, 104], periodo=1, tabla_rce='opc_ruteo_control_estatico', tabla_rcd='opc_ruteo_control_dinamico', tabla_cp='opc_ruteo_control_peso'):
